"""
plot_temperature_1M.py — Plot temperature for the first 1 million data points

Plots all 20 main stack temperature sensors + 4 side tube sensors + 2 ambient
(top/bottom BMP280) over the first 1M raw samples.

Usage:
    python plot_temperature_1M.py
"""
